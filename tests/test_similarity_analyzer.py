...
from jirascope.models import DuplicateReport, DuplicateCandidate
...
class TestSimilarityAnalyzer:
    ...
    @pytest.mark.asyncio
    async def test_find_potential_duplicates_success(self, mock_config, mock_clients, sample_work_items):
    ...
    @pytest.mark.asyncio
    async def test_find_potential_duplicates_no_duplicates(self, mock_config, mock_clients, sample_work_items):
    ...
    async def test_context_manager_initialization(self, mock_config):
        ...
        with patch('jirascope.analysis.similarity_analyzer.LMStudioClient') as mock_lm, \
    ...
    @pytest.mark.asyncio 
    async def test_error_handling_embedding_failure(self, mock_config, mock_clients, sample_work_items):
